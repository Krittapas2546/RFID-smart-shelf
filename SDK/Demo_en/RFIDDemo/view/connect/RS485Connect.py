...
from RFIDDemo.ui.connect.rs485Connect import Ui_Form
...
#   RS485连接
class RS485Connect(Ui_Form, QMainWindow):
    insert_ask_info_done_signal = pyqtSignal(int)

    def __init__(self, data=None):
        super(RS485Connect, self).__init__()
        self.setupUi(self)
    ...
    def init_ui(self):
        ...
        if Demo.Demo.demoLanguage == ELanguage.English:
            self.trans.load('RFIDDemo/ui/connect/rs485ConnectEnglish')
    ...
    def connect(self):
        try:
            ...
            param = "RS485:" + self.lb_param.text() + ":" + self.cb_com.currentText() + ":" + self.cb_baudrate.currentText()
            if Demo.Demo.reader.initReader("RS485:"+ param, self.parentForm):
